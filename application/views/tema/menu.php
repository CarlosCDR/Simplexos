...
<nav id="sidebar">
    <div id="newlog">
        <div class="icon2">
            <img src="<?php echo base_url() ?>assets/img/logo-simplexos.png">
        </div>
    ...
    <!-- Start Pesquisar-->
    <li class="search-box">
        <form style="display: flex" action="<?= site_url('Simplexos/pesquisar') ?>">
            ...
            <ul class="menu-links" style="position: relative;">
                ...
                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vLancamento')) { ?>
                    <li class="<?php if (isset($menuCobrancas)) {
                        ...
                        <!--Menu cobranças desabilitado e/ou não implementado<a class="tip-bottom" title="" href="<?= site_url('cobrancas/cobrancas') ?>"><i class='bx bx-dollar-circle iconX'></i>
