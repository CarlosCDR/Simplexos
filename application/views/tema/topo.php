...
<head>
  <title><?= $configuration['app_name'] ?: 'Simplexos' ?></title>
  <meta charset="UTF-8" />
    ...
    <ul class="nav">
      <li class="dropdown">
        ...
        <!--<li class=""><a title="Área do Cliente" href="<?= site_url(); ?>/mine" target="_blank"> <span class="text">Área do Cliente</span></a></li>-->
          <li class=""><a title="Meu Perfil" href="<?= site_url('Simplexos/minhaConta'); ?>"><span class="text">Meu Perfil</span></a></li>
          <li class="divider"></li>
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
        <li><a href="<?= site_url('Simplexos/configurar') ?>">Sistema</a></li>
        <li><a href="<?= site_url('usuarios') ?>">Usuários</a></li>
        <li><a href="<?= site_url('Simplexos/emitente') ?>">Emitente</a></li>
        <li><a href="<?= site_url('permissoes') ?>">Permissões</a></li>
        <li><a href="<?= site_url('auditoria') ?>">Auditoria</a></li>
        <li><a href="<?= site_url('Simplexos/emails') ?>">Emails</a></li>
        <li><a href="<?= site_url('Simplexos/backup') ?>">Backup</a></li>
        </ul>
      </li>
</ul>
</div>
...
<div id="userr" style="padding-right:45px;display:flex;flex-direction:column;align-items:flex-end;justify-content:center;">
  ...
  <div class="profile">
    <div class="profile-img">
      <a href="<?= site_url('Simplexos/minhaConta'); ?>"><img src="<?= !is_file(FCPATH . "assets/userImage/" . $this->session->userdata('url_image_user_admin')) ?  base_url() . "assets/img/User.png" : base_url() . "assets/userImage/" . $this->session->userdata('url_image_user_admin') ?>" alt=""></a>
    </div>
  </div>
</section>
...
<div style="display: none" id="search">
    <form action="<?= site_url('Simplexos/pesquisar') ?>">
