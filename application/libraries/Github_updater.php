...
class Github_updater
{
    ...
    public function update()
    {
        ...
        if ($hash !== $this->ci->config->item('current_commit')) {
            ...
            if ($dir = $this->_get_and_extract($hash)) {
                ...
                // Update the Simplexos version in the config filename
    ...
    */
    ...
    /**
    * Get Simplexos current version.
    *
    * @return string Simplexos current version.
    */
    private function getCurrentVersion()
    {
        ...
        if (!$version) {
            throw new Exception('Error getting Simplexos version from GitHub!');
        }
